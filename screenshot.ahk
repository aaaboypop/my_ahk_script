...
if(save_location="")
{
    save_location := A_WorkingDir . "\" . a_now . ".jpg"
}
...
;MsgBox, % save_location
file_s:= save_location . a_now . ".jpg"
;CaptureScreen(0,false,file_s,95)
;MsgBox,% "Mode = " mode "`nPosition = " position "`nSave = " save_location "`nQuality = " quality
CaptureScreen(mode,position,save_location,quality)
